...
describe('Blockchain', () => {
    let blockchain: Blockchain, newChain: Blockchain, originalChain: Block[], errorMock: jest.Mock;
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and has multiple blocks', () => {
            beforeEach(() => {
                ...
                blockchain.addBlock({data: ["beatsbears"]})
    ...
    describe('replaceChain()', () => {
        ...
        describe('when the chain is longer', () => {
            beforeEach(() => {
                ...
                newChain.addBlock({data: ["beatsbears"]})
